...
if ($usuarioLogado) {
    ...
    $temPlanoAtivo = $usuarioPlanoDAO->temPlanoAtivo($_SESSION['usuario']['id'] ?? 0);
    if ($temPlanoAtivo) {
        $planoAtivo = $usuarioPlanoDAO->getPlanoAtivo($_SESSION['usuario']['id'] ?? 0);
    }
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <link rel="stylesheet" href="../Public/css/planos.css">
...
<body>
    ...
    <nav>
        ...
        <section class="nav-centro">
            ...
            <a class="btn-nav-centro btn-ativo" href="planos.php">Planos</a>
    ...
    <main>
        <section class="planos-container">
            <div class="planos-header">
                ...
                <p>Planos que se adaptam ao seu estilo de vida</p>
                <?php if ($temPlanoAtivo && $planoAtivo): ?>
                    <div class="alert alert-info mt-3" style="max-width: 600px; margin: 20px auto;">
                        <i class="fas fa-info-circle me-2"></i>
                        <strong>Você possui um plano ativo!</strong><br>
                        Plano: <?php echo htmlspecialchars($planoAtivo['descricao_plano'] ?? 'N/A'); ?><br>
                        Válido até: <?php echo date('d/m/Y', strtotime($planoAtivo['data_fim_plano'])); ?>
                    </div>
                <?php endif; ?>
            </div>
    ...
    <script>
        document.body.dataset.temPlanoAtivo = '<?php echo $temPlanoAtivo ? '1' : '0'; ?>';
    </script>
    <script src="../Public/js/planos.js"></script>
</body>
</html>
